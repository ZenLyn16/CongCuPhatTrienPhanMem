...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-white">
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent1">
			<!-- Navbar brand -->
			<a class="navbar-brand mt-2 mt-sm-0" href="list-books"> <img
				src="img/book.png" height="35" alt="My Book Store Logo"/>
			</a>
			<!-- Left links -->
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				<li class="nav-item active"><a class="nav-link " href="list-books">Trang chủ</a>
				</li>
				<li class="nav-item"><a class="nav-link"
					href="https://nhasachphuongnam.com/">Giới thiệu</a></li>
				<c:if test="${account.account_is_admin == 1}">
					<li class="nav-item"><a class="nav-link"
						href="manage-account">Quản lý tài khoản</a></li>
				</c:if>
				<c:if test="${account.account_is_sell == 1}">
					<li class="nav-item"><a class="nav-link"
						href="manage-category">Quản lý danh mục</a></li>
					<li class="nav-item"><a class="nav-link"
						href="manage-product">Quản lý sản phẩm</a></li>
				</c:if>
			</ul>
			<!-- Left links -->
		</div>
		...
		<div class="d-flex align-items-center">
			...
			<c:if test="${account == null}">
				<a href="views/web/Login.jsp" class="border rounded px-2 nav-link">
					<i class="fa-solid fa-clipboard"></i> Đăng nhập
				</a>
			</c:if>
