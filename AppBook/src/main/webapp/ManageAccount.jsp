	    ...
	    <table class="table table-sm table-striped">
		  ...
		  <c:forEach items="${itemsA}" var="x">
		    <tr> 
		      ...
		      <td>
		      	<a href="edit-book?book_id=${x.account_id}" class="btn btn-secondary" data-mdb-ripple-init>
			  ...
			  <div class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <div class="modal-footer">
			        ...
			        <a href="delete-book?book_id=${x.account_id}" class="btn btn-danger" data-mdb-ripple-init><i class="fa-solid fa-trash-can me-1"></i>Delete</a>
			      </div>
			    </div>
			  </div>
			</div>
